...
module.exports = async function validateUpdateToken(request, response, next){
    try {
        ...
        logger.log('info', 'User Id : '+ userIdFromToken +' : ValidateUpdateTokenMiddleware : validateUpdateToken : GET_INFO_USER_LOGIN : ' +  JSON.stringify(GET_INFO_USER_LOGIN));
        ...
        // to check whether logged in user is having access to the module.
