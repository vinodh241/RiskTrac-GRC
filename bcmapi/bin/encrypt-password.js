 ...
 * Run from bcmapi folder, or from repo root: node bcmapi/bin/encrypt-password.js <plainPassword>
 */
...
const r = spawnSync(process.execPath, [script, pwd, 'bcmapi'], { stdio: 'inherit', cwd: repoRoot });
