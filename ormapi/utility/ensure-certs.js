/**
 * Ensures ormapi config/certs has public.pem and private.pem for decrypting SFTP/DB secrets.
...
function ensureCerts() {
  ...
  try {
    ...
    if (typeof console !== 'undefined') console.log('ORM API: generated new certs in config/certs (private.pem, public.pem)');
    return true;
  } catch (e) {
    if (typeof console !== 'undefined') console.error('ORM API: failed to generate certs:', e && (e.message || e));
    return false;
  }
}
