...
class InAppNotificationRT {
     ...
     */
    start() {
        this.app.post('/operational-risk-management/inApp-notification/get-user-alerts', TOKEN_UPDATE_MIDDELWARE, this.inAppNotificationBlObject.getUserAlerts);
        this.app.post('/operational-risk-management/inApp-notification/update-user-alerts', TOKEN_UPDATE_MIDDELWARE, this.inAppNotificationBlObject.updateUserAlerts);
        this.app.post('/operational-risk-management/inApp-notification/delete-user-alerts', TOKEN_UPDATE_MIDDELWARE, this.inAppNotificationBlObject.deleteUserAlerts);
    }
