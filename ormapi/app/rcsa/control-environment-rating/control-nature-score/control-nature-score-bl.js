...
class ControlNatureScoreBl {
    ...
    async getAllControlNatureScore(request, response) {
        ...
        try {
            ...
            const result = await ControlNatureScoreDbObject.getAllControlNatureScore(binds, accountGUIDFromToken);
    ...
    async getAllActiveControlNatureScore(request, response) {
        ...
        try {
            ...
            const result = await ControlNatureScoreDbObject.getAllActiveControlNatureScore(binds, accountGUIDFromToken);
    ...
    async getControlNatureScoreByID(request, response) {
        ...
        try {
            ...
            const result = await ControlNatureScoreDbObject.getControlNatureScoreByID(binds, accountGUIDFromToken);
    ...
    async addControlNatureScore(request, response) {
        ...
        try {
            ...
            const result = await ControlNatureScoreDbObject.addControlNatureScore(binds, accountGUIDFromToken);
    ...
    async updateControlNatureScore(request, response) {
        ...
        try {
            ...
            const result = await ControlNatureScoreDbObject.updateControlNatureScore(binds, accountGUIDFromToken);
    ...
    async updateControlNatureScoreStatus(request, response) {
        ...
        try {
            ...
            const result = await ControlNatureScoreDbObject.updateControlNatureScoreStatus(binds, accountGUIDFromToken);
