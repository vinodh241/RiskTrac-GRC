...
module.exports = class NotificationDBManager {
    ...
    async addNotification(userIdFromToken,notificationMaster) {
        ...
        try { 
            ...
            request.input('ToIDs',          MSSQL.NVarChar,     removeDuplicateEmails(notificationMaster.recepientEmailID));
            request.input('FromID',         MSSQL.NVarChar,     removeDuplicateEmails(notificationMaster.senderEmailID));
            request.input('CCIDs',          MSSQL.NVarChar,     removeDuplicateEmails(notificationMaster.CCIDs));           
            ...
            notificationlogger.log('info', 'User Id : ' + userIdFromToken + ' : NotificationDBManager : addNotification : Input parameters value for ORM.AddEmailAlerts procedure.');            
            notificationlogger.log('info', 'User Id : ' + userIdFromToken + ' : NotificationDBManager : addNotification : recepientEmailID  ='+ removeDuplicateEmails(notificationMaster.recepientEmailID));
            notificationlogger.log('info', 'User Id : ' + userIdFromToken + ' : NotificationDBManager : addNotification : senderEmailID     ='+ removeDuplicateEmails((notificationMaster.senderEmailID)));
            notificationlogger.log('info', 'User Id : ' + userIdFromToken + ' : NotificationDBManager : addNotification : CCIDs             ='+ removeDuplicateEmails(notificationMaster.CCIDs));
            ...
            return request.execute('ORM.AddEmailAlerts').then(function (result) {
                notificationlogger.log('info', 'User Id : ' + userIdFromToken + ' : NotificationDBManager : addNotification : Output parameters value of ORM.AddEmailAlerts procedure.');
