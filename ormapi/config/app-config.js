...
const APP_SERVER = {
    ...
    ALLOWED_ORIGINS         : ["https://serisktracgrcqa.secureyes.net","https://serisktracgrcdev.secureyes.net","http://localhost:5000"]      // Alowed origins list, else we will get CORS policy error.
};
