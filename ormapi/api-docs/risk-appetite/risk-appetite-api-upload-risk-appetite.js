...
module.exports = {
    tags: ["Risk Appetite"],
    description:
        "Description: \n- This api is responsible for uploading the Risk Appetite.",
    operationId: "uploadRiskAppetite",
    security: [
        {
            bearerAuth: [],
        },
        ...
        content: {
            "multipart/form-data": {
                schema: {
                    ...
                    required: ["UploadFile", "UploadFile", "token", "policyName"]
                },
                encoding: {
                    UploadFile: {
                                    ...
                                    example: [
                                        {
                                            ...
                                            "UploadDate": "2025-11-05T11:58:32.720Z"
                                        },
                                        {
                                            "FWID": "37",
