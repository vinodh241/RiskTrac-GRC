...
const APP_SERVER = {
    ...
    ALLOWED_ORIGINS         : ["http://localhost:5000","http://localhost:9002","http://localhost:4200","http://10.0.1.32:8080","http://127.0.0.1:8080"]       // Allowed origins (add nginx host for Docker)
};
