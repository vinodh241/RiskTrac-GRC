 ...
 * Run from umapi folder, or from repo root: node umapi/bin/encrypt-password.js <plainPassword>
 */
...
const r = spawnSync(process.execPath, [script, pwd, 'umapi'], { stdio: 'inherit', cwd: repoRoot });
