...
module.exports = class EmailDBManager {
    ...
    async getEmailAlertData(alertID) {
        ...
        try {
            ...
            notificationlogger.log('info', 'EmailDBManager : getEmailAlertData : input parameters value of [UM].EmailNotification procedure.');
            notificationlogger.log('info', 'EmailDBManager : getEmailAlertData : alertID    = ' + alertID);           

            return request.execute('[UM].EmailNotification').then(function (result) {
            notificationlogger.log('info', 'EmailDBManager : getEmailAlertData : Output parameters value of [UM].EmailNotification procedure.');
    ...
    async updateEmailAlertData(alertID, status) {
        ...
        try {
            ...
            notificationlogger.log('info', 'EmailDBManager : updateEmailAlertData : Input parameters value of [UM].UpdateEmailAlerts procedure.');
            ...
            return request.execute('[UM].UpdateEmailAlerts').then(function (result) {
            notificationlogger.log('info', 'EmailDBManager : updateEmailAlertData : Output parameters value of [UM].UpdateEmailAlerts procedure.');
