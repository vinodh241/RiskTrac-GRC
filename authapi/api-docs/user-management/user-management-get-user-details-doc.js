module.exports = {
  ...
  description:
    "Description: \n- This api is responsible for getting the user details from AD server \n- When user login, the login api endpoint will hit this endpoint to get the user details from the AD server.",
  operationId: "getUserDetailsFromAD",
  security: [
    {
      bearerAuth: [],
    },
