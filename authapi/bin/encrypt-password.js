 ...
 * Run from authapi folder, or from repo root: node authapi/bin/encrypt-password.js <plainPassword>
 */
...
const r = spawnSync(process.execPath, [script, pwd, 'authapi'], { stdio: 'inherit', cwd: repoRoot });
